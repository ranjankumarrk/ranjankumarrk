...
<div align="center">
  <img src="https://skillicons.dev/icons?i=ts,js,go,nodejs,nestjs,express,react,nextjs,postgres,mysql,mongodb,redis,aws,docker,kubernetes,githubactions,git,kafka,linux,html,css,tailwind&perline=11" alt="Skill icons" />
</div>

<br/>

**Languages** — TypeScript, JavaScript (ES6+), Golang  
**Backend** — Node.js, NestJS, Express.js, Bun.js, Gin, net/http, goroutines & channels  
**Frontend** — React.js, Next.js, Tailwind CSS  
**Data** — PostgreSQL, MySQL, MongoDB, Redis, TypeORM, Prisma, Mongoose  
**Cloud** — AWS EC2, Lambda, ECS, S3, SQS, SES, CloudWatch, IAM  
**Platform** — Docker, Kubernetes, GitHub Actions, Kafka, BullMQ, OpenTelemetry  
**Quality** — Jest, Supertest, Playwright, OpenAPI / Swagger  
**FinTech** — Plaid, Persona, Atelio-Bond, Oracle Watchlist Screening (OWS), Oracle EDQ

---

## Experience

### EWNS Web Services Pvt Ltd · Hyderabad (Remote)
...
**Software Developer** · Apr 2022 – Jan 2023

- Cut page load **4.2s → 1s** with lazy loading, image compression, and caching.
- Worked across Golang (Gin, net/http, goroutines), Node.js, Redis, PostgreSQL, AWS S3 / EC2 / CloudWatch, and Docker.
...
| GATE 2022 | LeetCode | Hackathon | Education |
| :---: | :---: | :---: | :---: |
| **AIR 1800** · CSE | **100+** DSA problems | **1st prize** · LNCT TechFest | B.Tech · LNCT Bhopal · **7.88/10** |

</div>

<div align="center">
  <a href="https://leetcode.com/u/ranjankumarrk/">
    <img src="https://leetcard.jacoblin.cool/ranjankumarrk?theme=dark&font=jetbrains_mono&ext=heatmap&cache=0&v=2026-09-12" alt="LeetCode stats" />
  </a>
</div>
...
<div align="center">
  <img height="165" src="https://github-readme-stats-anuraghazra1.vercel.app/api?username=ranjankumarrk&show_icons=true&hide_border=true&title_color=58A6FF&icon_color=58A6FF&text_color=c9d1d9&bg_color=0d1117&cache_seconds=1800&v=2026-09-12" alt="GitHub stats" />
  <img height="165" src="https://github-readme-stats-anuraghazra1.vercel.app/api/top-langs/?username=ranjankumarrk&layout=compact&hide_border=true&title_color=58A6FF&text_color=c9d1d9&bg_color=0d1117&langs_count=6&cache_seconds=1800&v=2026-09-12" alt="Top languages" />
</div>

<div align="center">
  <img src="https://streak-stats.demolab.com/?user=ranjankumarrk&theme=dark&hide_border=true&background=0D1117&ring=58A6FF&fire=58A6FF&currStreakNum=58A6FF&v=2026-09-12" alt="GitHub streak" />
</div>
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/ranjankumarrk/ranjankumarrk/output/github-contribution-grid-snake-dark.svg?v=2026-09-12" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/ranjankumarrk/ranjankumarrk/output/github-contribution-grid-snake.svg?v=2026-09-12" />
    <img alt="GitHub contribution snake" src="https://raw.githubusercontent.com/ranjankumarrk/ranjankumarrk/output/github-contribution-grid-snake-dark.svg?v=2026-09-12" />
  </picture>
</div>
